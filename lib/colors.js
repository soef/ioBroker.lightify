...
var minmax = function (v, min, max) {
    if(v < min) return min;
    if(v > max) return max;
    return v;
};
var mmrgb = function (v) {
    return (minmax(v, 0, 255));
};

var checkRGB = function (co) {
    //for (var i in co) {
...
exports.roundRGB = roundRGB;
exports.checkRGB = checkRGB;
exports.mmrgb    = mmrgb;
